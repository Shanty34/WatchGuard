...
class Detection(QThread):
    ...
    def run(self):
        ...
        # Loads Yolov4
        net = cv2.dnn.readNet(
            "Weapons/Wea/Client_Side/weights/yolov3_training_2000.weights",
            "Weapons/Wea/Client_Side/weights/yolov4.cfg",
        )
        classes = []
        # Loads object names
        with open("Weapons/Wea/Client_Side/obj.names", "r") as f:
